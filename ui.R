...
dashboardPage(
  ...
  dashboardHeader(title="Exploring the 1973 US Arrests data with R & Shiny Dashboard", titleWidth = 650, 
                  tags$li(class="dropdown",tags$a(href="https://www.linkedin.com/in/nileshrpal/?original_referer=https%3A%2F%2Fwww%2Egoogle%2Ecom%2F&originalSubdomain=in" ,icon("linkedin"), "Nilesh", target="_blank")),
                  tags$li(class="dropdown",tags$a(href="https://www.linkedin.com/in/karanpanda/?originalSubdomain=in" ,icon("linkedin"), "Karan", target="_blank")),
                  tags$li(class="dropdown",tags$a(href="https://www.linkedin.com/in/nishant-pandey-546989227/?originalSubdomain=in" ,icon("linkedin"), "Nishant", target="_blank"))
                  ),
